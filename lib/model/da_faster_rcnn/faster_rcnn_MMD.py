...
from model.da_faster_rcnn.MMD import MMD_loss
import time
import pdb
...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes, need_backprop,
        ...
        #
        # print('\ntgt_base_feat.size()\n')
        # print(tgt_base_feat.size())
        #
        # print('\n\t^◡^\n')
        # import sys
        # sys.exit(0)
        S_base_feat = base_feat.view(base_feat.size(1),-1)
        T_base_feat = tgt_base_feat.view(tgt_base_feat.size(1), -1)
        MMD_loss = self.MMD_LOSS(S_base_feat,T_base_feat)
