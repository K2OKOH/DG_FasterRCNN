...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        rois, bg_rois, rpn_loss_cls, rpn_loss_bbox = self.RCNN_rpn(base_feat, im_info, gt_boxes, num_boxes)

        if self.DB_flag:
            print(">> RPN finish")
            print("\troi sizes: ", rois.size())
        ...
        if cfg.POOLING_MODE == 'crop':
            ...
            bg_pooled_feat = self.RCNN_roi_align(base_feat, bg_rois.view(-1, 5))
        ...
        if self.DB_flag:
            print("feature_map: ",base_feat.size())
            print("pooled_feature: ",pooled_feat.size())
            print("bg_pooled_feature: ",bg_pooled_feat.size())
        ...
        fg_sim = F.cosine_similarity(pooled_feat, pooled_feat_2, 1, 1e-5).mean()
        bg_sim = F.cosine_similarity(bg_pooled_feat, bg_pooled_feat_2, 1, 1e-5).mean()
