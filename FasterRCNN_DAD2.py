...
from lib.model.faster_rcnn_DAD2.vgg16 import vgg16
from lib.model.faster_rcnn_DAD2.resnet import resnet
...
def parse_args():
    ...
    parser.add_argument('--vis', dest='vis',
                        ...
                        action='store_true')
    parser.add_argument('--log_flag', dest='log_flag',
    ...
    def train_model():
        ...
        if args.log_flag != 0:
            ...
            if not os.path.exists(log_dir):
                ...
                with open(loss_log_dir,"w") as f: 
                    f.write()   #这句话自带文件关闭功能，不需要再写f.close( )
                epoch_test_log_dir = log_dir + '/epoch_test_log.txt'
                with open(epoch_test_log_dir, 'w') as f2:
                    f2.write()
        ...
        for epoch in range(args.start_epoch, args.max_epochs + 1):
            ...
            with open(loss_log_dir,"a") as f: 
                f.write("epoch: %d" % (epoch))   #这句话自带文件关闭功能，不需要再写f.close( )
            ...
            for step in range(iters_per_epoch):
                ...
                if step % args.disp_interval == 0:
                    ...
                    with open(loss_log_dir,"a") as f: 
                        f.write("  count: %s  \tloss: %f\r" % (step-1,loss_temp.data))   #这句话自带文件关闭功能，不需要再写f.close( )
