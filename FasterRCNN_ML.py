...
def parse_args():
    ...
    parser.add_argument('--save_dir', dest='save_dir',
                        help='directory to save models', default="./SaveFile/model/ML",
                        type=str)
...
if __name__ == '__main__':    #仅作为脚本运行    
    ...
    setproctitle.setproctitle("< xmj_ML >")
    ...
    if args.mode == "train_model":
        ...
        if args.net == 'vgg16':
            fasterRCNN_1 = vgg16(imdb_s.classes, pretrained=True, class_agnostic=args.class_agnostic)
            fasterRCNN_2 = vgg16(imdb_s.classes, pretrained=True, class_agnostic=args.class_agnostic)
        elif args.net == 'res101':
            fasterRCNN_1 = resnet(imdb_s.classes, 101, pretrained=True, class_agnostic=args.class_agnostic)
            fasterRCNN_2 = resnet(imdb_s.classes, 101, pretrained=True, class_agnostic=args.class_agnostic)
        elif args.net == 'res50':
            fasterRCNN_1 = resnet(imdb_s.classes, 50, pretrained=True, class_agnostic=args.class_agnostic)
            fasterRCNN_2 = resnet(imdb_s.classes, 50, pretrained=True, class_agnostic=args.class_agnostic)
        elif args.net == 'res152':
            fasterRCNN_1 = resnet(imdb_s.classes, 152, pretrained=True, class_agnostic=args.class_agnostic)
            fasterRCNN_2 = resnet(imdb_s.classes, 152, pretrained=True, class_agnostic=args.class_agnostic)
        else:
        ...
        for epoch in range(args.start_epoch, args.max_epochs + 1):
            ...
            for step in range(iters_per_epoch):
                ...
                fasterRCNN_1.load_state_dict(fasterRCNN_2.state_dict())
                # fasterRCNN_1 = copy.deepcopy(fasterRCNN_2)
                ...
                rois_label = fasterRCNN_1(im_data, im_info, gt_boxes, num_boxes)

                loss = rpn_loss_cls.mean() + rpn_loss_box.mean() \
                    + RCNN_loss_cls.mean() + RCNN_loss_bbox.mean()
                loss_temp += loss.item()
                loss_meta_train = loss.data
                ...
                fasterRCNN_1.zero_grad()
                rois, cls_pdrob, bbox_pred, \
                rpn_loss_cls, rpn_loss_box, \
                RCNN_loss_cls, RCNN_loss_bbox, \
                rois_label = fasterRCNN_1(im_data_d1, im_info_d1, gt_boxes_d1, num_boxes_d1)

                loss = rpn_loss_cls.mean() + rpn_loss_box.mean() \
                    + RCNN_loss_cls.mean() + RCNN_loss_bbox.mean() + loss_meta_train
                loss_temp += loss.item()
                loss_true = loss.data
                ...
                rpn_loss_cls, rpn_loss_box, \
                RCNN_loss_cls, RCNN_loss_bbox, \
                rois_label = fasterRCNN_2(im_data_d1, im_info_d1, gt_boxes_d1, num_boxes_d1)
